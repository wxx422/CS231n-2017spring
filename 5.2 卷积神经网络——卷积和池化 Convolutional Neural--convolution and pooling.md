...
我们已经看到填充可以保证你想要输出的尺寸，以及在边角区域应用卷积核。在选择上，步长，卷积核，卷积核的大小，步长大小，零填充，通常的卷积核大小以后 3\*3 5\*5 7\*7，这些都是常用的大小。比如 3\*3 为了保持图像的空间尺寸进行宽度为1的零填充。如果卷积核为 5\*5，零填充的宽度为2。7\*7 零填充的宽度则为3。
